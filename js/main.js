document.getElementById("calculate-btn").addEventListener("click", function () {
  ...
  if (footprint < 5) {
    message =
      "Parabéns! Sua pegada ecológica é baixa. Você está fazendo um excelente trabalho para preservar o planeta.";
  } else if (footprint < 10) {
    message =
      "Sua pegada ecológica está na média. Há algumas áreas onde você pode melhorar para reduzir seu impacto.";
  } else {
    message =
      "Sua pegada ecológica é alta. Considere implementar mais práticas sustentáveis no seu dia a dia.";
  }

  document.getElementById(
    "footprint-value"
  ).textContent = `Sua pegada ecológica é ${footprint} toneladas de CO2 por ano.`;
...
document
  .querySelectorAll(".pillar-card, .tip-card, .news-card, .factor")
  .forEach((card) => {
